-- Adiciona novos campos de contexto para IA por empresa
ALTER TABLE public.companies
  ADD COLUMN IF NOT EXISTS ai_rules text,
  ADD COLUMN IF NOT EXISTS ai_additional_info text;

COMMENT ON COLUMN public.companies.ai_rules IS 'Regras operacionais que a IA deve seguir durante o atendimento.';
COMMENT ON COLUMN public.companies.ai_additional_info IS 'Informacoes adicionais de contexto comercial para a IA.';
