...
COMMENT ON COLUMN public.companies.ai_visit_policy IS 'Regras de visita (agendamento, acompanhamento, finais de semana, etc.) para contexto da IA.';
COMMENT ON COLUMN public.companies.ai_target_audience IS 'Público-alvo principal da imobiliária para tom e priorização da IA.';
