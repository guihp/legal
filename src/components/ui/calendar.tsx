  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md w-8 sm:w-9 font-normal text-[0.65rem] sm:text-[0.8rem] capitalize",
        ...
        day: cn(
          ...
          "h-8 w-8 sm:h-9 sm:w-9 p-0 text-xs sm:text-sm font-normal aria-selected:opacity-100"
        ),
