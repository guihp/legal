...
import type { ConfigKpiItem } from './helpers';

type Props = {
  items: ConfigKpiItem[];
};

export const ConfigurationsKpis = memo(function ConfigurationsKpis({ items }: Props) {
          ...
          {kpi.hint ? (
            <p
              className={cn(
                ...
                kpi.hintTone === 'warning' && 'text-amber-700 dark:text-amber-400',
